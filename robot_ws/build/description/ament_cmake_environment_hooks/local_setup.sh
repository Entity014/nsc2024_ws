...
: ${AMENT_CURRENT_PREFIX:="/home/robot_ws/install/description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/description/environment/pythonpath.sh"
